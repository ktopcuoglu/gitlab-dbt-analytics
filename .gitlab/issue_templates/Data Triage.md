...
* [ ] React by investigating and respond to each **active** failure in **#data-pipelines** and **#data-prom-alerts by:**
    ...
    * [ ] Opening an incident in case a failure results in a data outage
    * [ ] [Creating an issue](https://gitlab.com/gitlab-data/analytics/issues/new?issuable_template=Triage%20Errors%20DE) for each issue
