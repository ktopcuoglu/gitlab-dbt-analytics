...
- [ ] To connect to jupyter: 
    - Either go to your web browser and copy paste the url and token found in terminal once the docker image creates. It should look something like `http://127.0.0.1:8888/lab?token=5c7f7da79f4a0968501f087f3c79ee4dd8bd7a63e0f088a8`. The token will change each time you spin up the docker container.
    - Or in Docker Desktop, locate the data-science container and click the "Open in Browser" icon within the dropdown.
