...
* Step 4:  Filter out the account from the [test](https://gitlab.com/gitlab-data/analytics/-/blob/master/transform/snowflake-dbt/tests/zuora/zuora_account_has_crm_id.sql) and submit your MR for review
