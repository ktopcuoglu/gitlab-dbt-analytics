{% macro default_usage_ping_information() %} 
    ...
    raw_usage_data_payload['host_id']::VARCHAR                                                              AS host_id, 
    raw_usage_data_payload['installation_type']::VARCHAR                                                    AS installation_type, 
    is_internal, 
    is_staging,    

    -- instance user statistics 
    raw_usage_data_payload['instance_user_count']::VARCHAR                                                  AS instance_user_count, 
    raw_usage_data_payload['historical_max_users']::VARCHAR                                                 AS historical_max_users, 
