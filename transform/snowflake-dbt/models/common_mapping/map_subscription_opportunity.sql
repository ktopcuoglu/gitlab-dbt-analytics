WITH zuora_account_source AS (
    ...
    FROM final
    LEFT JOIN prod.restricted_safe_common.fct_mrr
    ...
    INNER JOIN prod.restricted_safe_common.dim_crm_opportunity opp
      ON ii.invoice_number = opp.invoice_number
    INNER JOIN prod.restricted_safe_common.fct_crm_opportunity fct_opp
