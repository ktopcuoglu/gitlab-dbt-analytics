...
WITH customers_db_versions AS (
    ...
    SELECT 
      ...
      MAX(CASE WHEN column_key = 'start_date' THEN TRY_TO_DATE(column_value) END)::DATE                                     AS order_start_date,
      ...
      MAX(CASE WHEN column_key = 'end_date' THEN TRY_TO_DATE(column_value) END)::DATE                                       AS order_end_date,
    ...
    SELECT 
      ...
      order_quantity,
      order_created_at,
      dim_namespace_id::NUMBER            AS dim_namespace_id,
      dim_namespace_name,
      amendment_type,
      order_is_trial,
