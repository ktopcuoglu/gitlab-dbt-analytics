...
, gitlab_dotcom_epics_dedupe_source AS (
    ...
    LEFT JOIN prep_namespace ON gitlab_dotcom_epics_dedupe_source.group_id = prep_namespace.dim_namespace_id
    LEFT JOIN dim_namespace_plan_hist ON prep_namespace.ultimate_parent_namespace_id = dim_namespace_plan_hist.dim_namespace_id
    ...
    LEFT JOIN prep_user ON gitlab_dotcom_epics_dedupe_source.author_id = prep_user.dim_user_id
    LEFT JOIN dim_date ON TO_DATE(gitlab_dotcom_epics_dedupe_source.created_at) = dim_date.date_day
