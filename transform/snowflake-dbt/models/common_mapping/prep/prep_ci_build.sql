...
, gitlab_dotcom_ci_builds_source AS (
    ...
    SELECT
      ...
      gitlab_dotcom_ci_builds_source.ci_build_name AS name,
    ...
    LEFT JOIN prep_project ON gitlab_dotcom_ci_builds_source.ci_build_project_id = prep_project.dim_project_id
    ...
    LEFT JOIN prep_user ON gitlab_dotcom_ci_builds_source.ci_build_user_id = prep_user.dim_user_id
    LEFT JOIN dim_date ON TO_DATE(gitlab_dotcom_ci_builds_source.created_at) = dim_date.date_day
