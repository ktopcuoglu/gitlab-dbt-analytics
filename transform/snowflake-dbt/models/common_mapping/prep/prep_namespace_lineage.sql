...
, active_gitlab_subscriptions AS (
  ...
  -- Select all namespaces without parents
    ...
    SELECT
      ...
      recursive_namespaces.upstream_lineage[0]::NUMBER                          AS ultimate_parent_namespace_id, -- First item is the ultimate parent.
    ...
    SELECT
      ...
      extracted.parent_id,
      extracted.ultimate_parent_namespace_id,
    ...
    LEFT JOIN active_gitlab_subscriptions AS ultimate_parent_gitlab_subscriptions
      ON extracted.ultimate_parent_namespace_id = ultimate_parent_gitlab_subscriptions.namespace_id
