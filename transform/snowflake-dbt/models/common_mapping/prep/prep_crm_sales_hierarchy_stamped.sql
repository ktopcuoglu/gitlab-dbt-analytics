WITH sfdc_opportunity_sales_hierarchy AS (
    ...
    SELECT DISTINCT
      ...
      CASE 
        WHEN sales_segment_name_stamped IN ('Large', 'PubSec') THEN 'Large'
        ELSE sales_segment_name_stamped
      END sales_segment_name_stamped_grouped,
      ...
      {{ sales_segment_region_grouped('sales_segment_name_stamped', 'sales_region_name_stamped') }}                             AS segment_region_stamped_grouped,
