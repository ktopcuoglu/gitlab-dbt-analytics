WITH dim_date AS (
    ...
    SELECT
      ...
      next_renewal_month,
      last_renewal_month,
      COUNT(DISTINCT prep_crm_account.dim_crm_account_id)
    ...
    LEFT JOIN next_renewal_month
      ON next_renewal_month.dim_crm_account_id = prep_crm_account.dim_crm_account_id
    LEFT JOIN last_renewal_month
      ON last_renewal_month.dim_crm_account_id = prep_crm_account.dim_crm_account_id
    ...
    {{ dbt_utils.surrogate_key(['retention_subs.dim_crm_account_id','retention_month']) }}
      ...
      prep_crm_account.crm_account_name         AS crm_account_name,
      retention_month,
    ...
    LEFT JOIN prep_crm_account
      ON prep_crm_account.dim_crm_account_id = retention_subs.dim_crm_account_id
