WITH base AS (
    ...
    SELECT
      ...
      parent_crm_account_tsp_account_employees      AS parent_crm_account_tsp_account_employees,
      parent_crm_account_tsp_max_family_employees   AS parent_crm_account_tsp_max_family_employees,
      parent_crm_account_employee_count_band        AS parent_crm_account_employee_count_band,
      ...
      crm_account_employee_count_band               AS crm_account_employee_count_band,
