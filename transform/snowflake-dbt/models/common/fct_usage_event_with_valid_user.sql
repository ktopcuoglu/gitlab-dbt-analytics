...
fct_usage_event_with_valid_user AS (
    
    /*
    fct_usage_event_with_valid_user is at the atomic grain of event_id and event_created_at timestamp. All other derived facts in the GitLab.com usage events 
...
{{ dbt_audit(
    cte_ref="fct_usage_event_with_valid_user",
    created_by="@iweeks",
    updated_by="@iweeks",
