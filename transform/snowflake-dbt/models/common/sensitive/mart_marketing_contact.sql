WITH marketing_contact AS (
    ...
    SELECT DISTINCT
      ...
      usage_user_container_scanning_job_28_days_user,
    ...
    SELECT 
      ...
      SUM(usage_user_container_scanning_job_28_days_user)                                           AS usage_user_container_scanning_job_28_days_user,
    ...
    SELECT 
      ...
      usage_metrics.usage_user_container_scanning_job_28_days_user,
