  ...
  FROM {{ ref('map_crm_account') }}
    ...
    -- ids
     ...
     -- important person dates
      ...
      COALESCE(sfdc_contacts.inquiry_datetime_inferred, sfdc_leads.inquiry_datetime_inferred)::DATE             AS inquiry_datetime_inferred,
      {{ get_date_id('inquiry_datetime_inferred') }}                                                            AS inquiry_datetime_inferred_id,
      {{ get_date_pt_id('inquiry_datetime_inferred') }}                                                         AS inquiry_datetime_inferred_pt_id,
