...
deduped_namespace_bdg AS (
  ...
  SELECT
    namespace_order_subscription.dim_subscription_id AS dim_last_subscription_id,
...
dim_namespace_w_bdg AS (
  ...
  SELECT
    ...
    deduped_namespace_bdg.dim_last_subscription_id,
...
fct_event_w_flags AS (
  ...
  SELECT 
    ...
    dim_namespace_w_bdg.dim_last_subscription_id,
