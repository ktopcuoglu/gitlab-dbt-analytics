...
WITH date_details AS (
    ...
    SELECT
      ...
      term_start_dates.fiscal_year AS term_start_fiscal_year,
      term_end_dates.fiscal_year AS term_end_fiscal_year,
      CASE
    ...
    LEFT JOIN date_details term_start_dates
      ON zuora_subscription.term_start_date::DATE = term_start_dates.date_day
    LEFT JOIN date_details term_end_dates
      ON zuora_subscription.term_end_date::DATE = term_end_dates.date_day
