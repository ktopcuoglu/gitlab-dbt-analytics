WITH map_merged_crm_account AS (
  ...
  SELECT
    ...
    sfdc_account.account_demographics_segment           AS crm_account_demographics_segment,
    ...
    sfdc_account.account_demographics_employee_count    AS account_demographics_employee_count,
    sfdc_account.account_demographics_max_family_employee AS account_demographics_max_family_employee,
    sfdc_account.account_demographics_upa_country       AS account_demographics_upa_country,
    sfdc_account.account_demographics_upa_state         AS account_demographics_upa_state,
    sfdc_account.account_demographics_upa_city          AS account_demographics_upa_city,
    sfdc_account.account_demographics_upa_street        AS account_demographics_upa_street,
    sfdc_account.account_demographics_upa_postal_code   AS account_demographics_upa_postal_code,
