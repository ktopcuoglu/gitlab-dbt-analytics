...
WITH bamboohr_compensation AS (
    ...
    SELECT 
      ...
      ote_change+change_in_comp_usd                                                                   AS total_change_in_comp,
      ROUND((total_change_in_comp/(prior_compensation_value_usd+prior_ote_usd)),2)                    AS percent_change_in_comp
    FROM intermediate
