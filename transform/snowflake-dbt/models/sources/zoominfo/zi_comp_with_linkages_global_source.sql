WITH source AS (
    ...
    SELECT 
      zi_c_location_id::NUMBER			                    AS 	zi_c_location_id,
      zi_c_company_id::NUMBER			          	        AS 	zi_c_company_id,
      ...
      zi_c_company_name::VARCHAR						    AS 	zi_c_company_name,
      zi_c_company_url::VARCHAR							    AS 	zi_c_company_url,
      zi_c_company_street::VARCHAR							AS 	zi_c_company_street,
      zi_c_company_street_2::VARCHAR						AS 	zi_c_company_street_2,
      zi_c_company_city::VARCHAR							AS 	zi_c_company_city,
      zi_c_company_state::VARCHAR							AS 	zi_c_company_state,
      zi_c_company_zip::VARCHAR								AS 	zi_c_company_zip,
      zi_c_company_country::VARCHAR							AS 	zi_c_company_country,
      zi_c_company_cbsa_name::VARCHAR						AS 	zi_c_company_cbsa_name,
      zi_c_company_county::VARCHAR							AS 	zi_c_company_county,
      zi_c_company_latitude::FLOAT							AS 	zi_c_company_latitude,
      zi_c_company_longitude::FLOAT							AS 	zi_c_company_longitude,
      zi_c_company_verified_address::VARCHAR				AS 	zi_c_company_verified_address,
      zi_c_company_employee_range::VARCHAR					AS 	zi_c_company_employee_range,
      zi_c_company_employees::NUMBER						AS 	zi_c_hq_employees,
      zi_c_company_revenue_range::VARCHAR					AS 	zi_c_company_revenue_range,
      zi_c_company_revenue::NUMBER							AS 	zi_c_company_revenue,
      zi_c_company_phone::VARCHAR							AS 	zi_c_company_phone,
      zi_c_company_fax::VARCHAR								AS 	zi_c_company_fax,
      ...
      zi_c_immediate_parent_company_id::NUMBER				AS 	zi_c_immediate_parent_company_id,
      ...
      zi_c_domestic_parent_company_id::NUMBER				AS 	zi_c_domestic_parent_company_id,
      ...
      zi_c_global_parent_company_id::NUMBER					AS 	zi_c_global_parent_company_id,
      ...
      zi_c_franchisor_company_id::NUMBER					AS 	zi_c_franchisor_company_id,
