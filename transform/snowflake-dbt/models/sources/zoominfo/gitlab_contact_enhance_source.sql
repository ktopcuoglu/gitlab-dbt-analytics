WITH source AS (
    ...
    SELECT 
      ...
      "ZoomInfo Company ID"::VARCHAR	                            AS	zoominfo_company_id,
      ...
      "Est. Marketing Department Budget (in 000s)"::VARCHAR	        AS	est_marketing_department_budget,
      "Est. Finance Department Budget (in 000s)"::VARCHAR	        AS	est_finance_department_budget,
      ...
      "Employees"::VARCHAR                                      	AS	employees,
