WITH zuora_revenue_revenue_contract_line AS (
    ...
    SELECT 
      ...
      so_book_date::DATE                                AS sales_order_book_date,
      ...
      disc_amt::DECIMAL                                 AS discount_amount,
      disc_pct::DECIMAL                                 AS discount_percent,
      ...
      fv_pct::DECIMAL                                   AS fair_value_percent,
      fv_prc::DECIMAL                                   AS fair_value_price,
      ...
      date1::DATE                                       AS revenue_contract_line_date_1,
      date2::DATE                                       AS revenue_contract_line_date_2,
      date3::DATE                                       AS revenue_contract_line_date_3,
      date4::DATE                                       AS revenue_contract_line_date_4,
      date5::DATE                                       AS revenue_contract_line_date_5,
      model_id::VARCHAR                                 AS model_id,
      unschd_adj::VARCHAR                               AS unscheduled_adjustment,
      posted_pct::DATE                                  AS posted_percent,
      rel_pct::DATE                                     AS released_percent,
      ...
      schd_ship_dt::DATE                                AS scheduled_ship_date,
      ship_dt::DATE                                     AS ship_date,
      ...
      ct_mod_date::DATE                                 AS contract_modification_date,
      ct_num::VARCHAR                                   AS contract_number,
      ct_date::DATE                                     AS contract_date,
      ...
      crtd_dt::DATE                                     AS revenue_contract_line_created_date,
      updt_by::VARCHAR                                  AS revenue_contract_line_updated_by,
      updt_dt::DATE                                     AS revenue_contract_line_updated_date,
      ...
      fv_date::DATE                                     AS fair_value_date,
      orig_fv_date::DATE                                AS original_fair_value_date,
      vc_amt::DECIMAL                                   AS varaiable_consideration_amount,
      unit_sell_prc::DECIMAL                            AS unit_sell_price,
      unit_list_prc::DECIMAL                            AS unit_list_price,
      impair_retrieve_amt::DECIMAL                      AS impairment_retrieve_amount,
      bndl_prnt_id::VARCHAR                             AS bundle_parent_id,
      company_code::VARCHAR                             AS company_code,
      cancel_flag::VARCHAR                              AS is_cancelled,
      below_fv_prc::DECIMAL                             AS below_fair_value_price,
      above_fv_prc::DECIMAL                             AS above_fair_value_price,
      fv_tmpl_id::VARCHAR                               AS fair_value_template_id,
      fv_expr::VARCHAR                                  AS fair_value_expiration,
      below_mid_pct::DECIMAL                            AS below_mid_percent,
      above_mid_pct::DECIMAL                            AS above_mid_percent,
      ...
      tot_bgd_hrs::DECIMAL                              AS total_budget_hours,
      tot_bgd_cst::DECIMAL                              AS total_budget_cost,
      fcst_date::DATE                                   AS forecast_date,
      ...
      tp_pct_ssp::DECIMAL                               AS transaction_price_ssp_percent,
      orig_quantity::DECIMAL                            AS original_quantity,
      split_ref_doc_line_id::VARCHAR                    AS split_reference_document_line_id,
      overstated_amt::DECIMAL                           AS overstated_amount,
      ovst_lst_amt::DECIMAL                             AS overstated_list_price_amount,
      ...
      mr_org_prc::DECIMAL                               AS material_rights_org_percent,
      action_type::VARCHAR                              AS action_type,
      pord_def_amt::DECIMAL                             AS pord_deferred_amount,
      pord_rec_amt::DECIMAL                             AS pord_recognized_amount,
      net_sll_prc::DECIMAL                              AS net_sell_price,
      net_lst_prc::DECIMAL                              AS net_list_price,
      ...
      subscrp_start_date::DATE                          AS subscription_start_date,
      subscrp_end_date::DATE                            AS subscription_end_date,
      ...
      charge_crtd_date::DATE                            AS charge_created_date,
      charge_last_updt_date::DATE                       AS charge_last_updated_date,
      ...
      ssp_sll_prc::DECIMAL                              AS ssp_sell_price,
      ssp_lst_prc::DECIMAL                              AS ssp_list_price,
      subscrp_trm_st_dt::DATE                           AS subscription_term_start_date,
      subscrp_trm_end_dt::DATE                          AS subscription_term_end_date,
      subscrp_term_num::VARCHAR                         AS subscrp_term_number,
      old_sell_prc::DECIMAL                             AS old_sell_price,
      ...
      ramp_alloc_pct::DECIMAL                           AS ramp_allocation_percent,
      ramp_alctbl_prc::DECIMAL                          AS ramp_allocatable_percent,
      ramp_alctd_prc::DECIMAL                           AS ramp_allocted_percent,
      ramp_cv_amt::DECIMAL                              AS ramp_carve_amount,
      ramp_cum_cv_amt::DECIMAL                          AS ramp_cumulative_carve_amount,
      ramp_cum_alctd_amt::DECIMAL                       AS ramp_cumulative_allocated_amount,
