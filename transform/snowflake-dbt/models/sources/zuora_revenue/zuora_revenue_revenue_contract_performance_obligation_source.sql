WITH zuora_revenue_performance_obligation AS (
    ...
    SELECT 
      ...
      start_date::DATE                              AS revenue_contract_performance_obligation_start_date,
      end_date::DATE                                AS revenue_contract_performance_obligation_end_date,
      rev_timing::VARCHAR                           AS revenue_timing,
      rev_start_dt::DATE                            AS revenue_start_date,
      rev_end_dt::DATE                              AS revenue_end_date,
      ...
      rc_pob_crtd_dt::DATE                          AS revenue_contract_performance_obligation_created_date,
      rc_pob_updt_by::VARCHAR                       AS revenue_contract_performance_obligation_updated_by,
      rc_pob_updt_dt::DATE                          AS revenue_contract_performance_obligation_updated_date,
      pob_tmpl_crtd_by::VARCHAR                     AS performance_obligation_template_created_by,
      pob_tmpl_crtd_dt::DATE                        AS performance_obligation_template_created_date,
      pob_tmpl_updt_by::VARCHAR                     AS performance_obligation_template_updated_by,
      pob_tmpl_updt_dt::DATE                        AS performance_obligation_template_updated_date,
      event_crtd_by::VARCHAR                        AS event_created_by,
      event_crtd_dt::DATE                           AS event_created_date,
      event_updt_by::VARCHAR                        AS event_updated_by,
      event_updt_dt::DATE                           AS event_updated_date,
      ...
      tolerance_pct::DECIMAL                        AS tolerance_percent,
      ...
      rel_base_date::DATE                           AS release_base_date,
