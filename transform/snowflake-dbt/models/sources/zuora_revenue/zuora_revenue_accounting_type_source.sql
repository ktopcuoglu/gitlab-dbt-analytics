WITH zuora_revenue_accounting_type AS (
    ...
    SELECT 
      ...
      vc_acct_flag::VARCHAR				AS is_vc_account,
      vc_clr_acct_flag::VARCHAR			AS is_vc_clearing_account,
      ...
      crtd_dt::DATE						AS accounting_type_created_date,
      updt_by::VARCHAR					AS accounting_type_updated_by,
      updt_dt::DATE						AS accounting_type_updated_date,
