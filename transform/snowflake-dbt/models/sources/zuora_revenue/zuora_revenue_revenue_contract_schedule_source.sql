WITH zuora_revenue_revenue_contract_schedule AS (
    ...
    SELECT 
      ...
      CONCAT(post_prd_id::VARCHAR, '01')            AS posted_period_id,
      ...
      CONCAT(crtd_prd_id::VARCHAR, '01')            AS revenue_contract_schedule_created_period_id,
      ...
      CONCAT(updt_prd_id::VARCHAR, '01')            AS revenue_contract_schedule_update_period_id,
