WITH zuora_revenue_revenue_contract_schedule AS (
    ...
    SELECT 
      ...
      f_ex_rate::DECIMAL                            AS functional_currency_exchange_rate,
      ex_rate_date::DATE                            AS exchange_rate_date,
      ...
      g_ex_rate::DECIMAL                            AS reporting_currency_exchange_rate,
      rel_id::VARCHAR                               AS release_action_id,
      rel_pct::DECIMAL                              AS release_percent,
      ...
      cr_amount::DECIMAL                            AS transactional_credit_amount,
      f_dr_amount::DECIMAL                          AS functional_debit_amount,
      f_cr_amount::DECIMAL                          AS functional_credit_amount,
      g_dr_amount::DECIMAL                          AS reporting_debit_amount,
      g_cr_amount::DECIMAL                          AS reporting_credit_amount,
      ...
      bld_fx_dt::DATE                               AS billed_fx_date,
      bld_fx_rate::DECIMAL                          AS billed_fx_rate,
      ...
      pp_amt::DECIMAL                               AS previous_period_amount,
      pq_amt::DECIMAL                               AS previous_quarter_amount,
      py_amt::DECIMAL                               AS previous_year_amount,
