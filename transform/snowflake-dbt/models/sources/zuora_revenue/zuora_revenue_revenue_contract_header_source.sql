WITH zuora_revenue_revenue_contract_header AS (
    ...
    SELECT 
      ...
      list_amt::VARCHAR                             AS list_amount,
      sell_amt::VARCHAR                             AS sell_amount,
      ca_amt::VARCHAR                               AS contract_asset_amount,
      cl_amt::VARCHAR                               AS contract_liability_amount,
      tot_cv_amt::VARCHAR                           AS carve_amount,
      ...
      init_pob_exp_dt::DATE                         AS initial_performance_obligation_expiration_date,
      ...
      crtd_prd_id::VARCHAR                          AS revenue_contract_created_period_id,
      client_id::VARCHAR                            AS client_id,
      sec_atr_val::VARCHAR                          AS security_attribute_value,
      crtd_by::VARCHAR                              AS revenue_contract_created_by,
      crtd_dt::DATE                                 AS revenue_contract_created_date,
      updt_by::VARCHAR                              AS revenue_contract_updated_by,
      updt_dt::DATE                                 AS revenue_contract_updated_date,
      incr_updt_dt::DATE                            AS incremental_update_date,
      ct_mod_end_dt::DATE                           AS revenue_contract_modification_end_date,
      ...
      acct_updt_dt::DATE                            AS account_updated_date,
      ...
      max_schd_prd::VARCHAR                         AS max_schedule_period,
      lifecycle_change_dt::DATE                     AS lifecycle_change_date,
      old_ct_mod_end_dt::DATE                       AS old_revenue_contract_modification_end_date,
