WITH zuora_revenue_approval_detail AS (
    ...
    pending_since::DATE                          AS pending_since, 
    ...
    rc_appr_crtd_dt::DATE                        AS revenue_contract_approval_created_date, 
    rc_appr_updt_by::VARCHAR                     AS revenue_contract_approval_updated_by, 
    rc_appr_updt_dt::DATE                        AS revenue_contract_approval_updated_date, 
    rc_rule_crtd_by::VARCHAR                     AS revenue_contract_rule_created__by, 
    rc_rule_crtd_dt::DATE                        AS revenue_contract_rule_created_date, 
    rc_rule_updt_by::VARCHAR                     AS revenue_contract_rule_updated_by, 
    rc_rule_updt_dt::DATE                        AS revenue_contract_rule_updatd_date, 
    appr_rule_crtd_by::VARCHAR                   AS approval_rule_created_by, 
    appr_rule_crtd_dt::DATE                      AS approval_rule_created_date, 
