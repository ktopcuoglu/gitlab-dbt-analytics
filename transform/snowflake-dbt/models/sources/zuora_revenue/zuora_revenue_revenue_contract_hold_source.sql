WITH zuora_revenue_revenue_contract_hold AS (
    ...
    SELECT 
      ...
      rc_hold_applied_dt::DATE                          AS revenue_contract_hold_applied_date,
      ...
      rc_hold_release_dt::DATE                          AS revenue_contract_hold_release_date,
      ...
      hold_crtd_dt::DATE                                AS hold_created_date,
      hold_updt_by::VARCHAR                             AS hold_update_by,
      hold_updt_dt::DATE                                AS hold_update_date,
      rc_hold_crtd_by::VARCHAR                          AS revenue_contract_hold_created_by,
      rc_hold_crtd_dt::DATE                             AS revenue_contract_hold_created_date,
      rc_hold_updt_by::VARCHAR                          AS revenue_contract_hold_updated_by,
      rc_hold_updt_dt::DATE                             AS revenue_contract_hold_updated_date,
      incr_updt_dt::DATE                                AS incremental_update_date,
      rc_hold_exp_date::DATE                            AS revenue_contract_hold_expiration_date,
      ...
      rev_hold_start_date::DATE                         AS revenue_hold_start_date,
      rev_hold_end_date::DATE                           AS revenue_hold_end_date,
