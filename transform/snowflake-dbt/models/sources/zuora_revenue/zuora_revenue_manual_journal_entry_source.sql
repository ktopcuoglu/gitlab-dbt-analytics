WITH zuora_revenue_manual_journal_entry AS (
    ...
    SELECT 
      ...
      func_amount::DECIMAL                          AS funcional_currency_amount,
      start_date::DATE                              AS manual_journal_entry_start_date,
      end_date::DATE                                AS manual_journal_entry_end_date,
      ...
      je_head_crtd_dt::DATE                         AS manual_journal_entry_header_created_date,
      je_head_updt_by::VARCHAR                      AS manual_journal_entry_header_updated_by,
      je_head_updt_dt::DATE                         AS manual_journal_entry_header_updated_date,
      je_line_crtd_by::VARCHAR                      AS manual_journal_entry_line_created_by,
      je_line_crtd_dt::DATE                         AS manual_journal_entry_line_created_date,
      je_line_updt_by::VARCHAR                      AS manual_journal_entry_line_updated_by,
      je_line_updt_dt::DATE                         AS manual_journal_entry_line_updated_date,
