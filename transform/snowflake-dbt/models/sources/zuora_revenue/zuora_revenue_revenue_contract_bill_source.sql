WITH zuora_revenue_revenue_contract_bill AS (
    ...
    SELECT 
      ...
      ext_sll_prc::DECIMAL              AS external_selling_price,
      def_amt::DECIMAL                  AS deferred_amount,
      rec_amt::DECIMAL                  AS recognized_amount,
      alctbl_xt_prc::DECIMAL            AS allocatable_external_price,
      ...
      start_date::DATE                  AS revenue_start_date,
      end_date::DATE                    AS revenue_end_date,
      ...
      ref_doc_line_id::VARCHAR          AS reference_doc_line_id,
      ...
      num1::DECIMAL                     AS revenue_contract_bill_number_1,
      num2::DECIMAL                     AS revenue_contract_bill_number_2,
      num3::DECIMAL                     AS revenue_contract_bill_number_3,
      num4::DECIMAL                     AS revenue_contract_bill_number_4,
      num5::DECIMAL                     AS revenue_contract_bill_number_5,
      num6::DECIMAL                     AS revenue_contract_bill_number_6,
      num7::DECIMAL                     AS revenue_contract_bill_number_7,
      num8::DECIMAL                     AS revenue_contract_bill_number_8,
      num9::DECIMAL                     AS revenue_contract_bill_number_9,
      num10::DECIMAL                    AS revenue_contract_bill_number_10,
      num11::DECIMAL                    AS revenue_contract_bill_number_11,
      num12::DECIMAL                    AS revenue_contract_bill_number_12,
      num13::DECIMAL                    AS revenue_contract_bill_number_13,
      num14::DECIMAL                    AS revenue_contract_bill_number_14,
      num15::DECIMAL                    AS revenue_contract_bill_number_15,
      date1::DATE                       AS revenue_contract_bill_date_1,
      date2::DATE                       AS revenue_contract_bill_date_2,
      date3::DATE                       AS revenue_contract_bill_date_3,
      date4::DATE                       AS revenue_contract_bill_date_4,
      date5::DATE                       AS revenue_contract_bill_date_5,
      credit_rule::VARCHAR              AS credit__rule,
      rel_pct::DECIMAL                  AS recognized_percent,
      cost_amt::DECIMAL                 AS cost_amount,
      cost_def_amt::DECIMAL             AS cost_deferred_amt,
      cost_rec_amt::DECIMAL             AS cost_recognized_amt,
      ...
      crtd_prd_id::VARCHAR              AS revenue_contract_bill_created_period_id,
      client_id::VARCHAR                AS client_id,
      sec_atr_val::VARCHAR              AS security_attribute_value,
      crtd_by::VARCHAR                  AS revenue_contract_bill_created_by,
      crtd_dt::DATE                     AS revenue_contract_bill_created_date,
      updt_by::VARCHAR                  AS revenue_contract_bill_updt_by,
      updt_dt::DATE                     AS revenue_contract_bill_updt_dt,
      ...
      ct_mod_date::DATE                 AS revenue_contract_line_modification_date,
      ...
      ca_account::VARCHAR               AS ca_account,
      ...
      lt_def_adj_acct::VARCHAR          AS lt_deferred_adjustment_account,
      ...
      rord_updt_flag::VARCHAR           AS is_rord_update,
      ...
      rem_init_entry_amt::DECIMAL       AS rem_init_entry_amount,
      subscrp_term_num::VARCHAR         AS subscrpription_term,
      rord_knock_off_flag::VARCHAR      AS is_rord_knock_off,
