...
WITH source AS (
    ...
    FROM {{ source('salesforce', 'opportunity') }}  AS opportunity
      ...
      SELECT
        ...
        {{ sales_segment_region_grouped('user_segment_stamped', 'user_geo_stamped') }}
        ...
        {{ sales_segment_region_grouped('sao_crm_opp_owner_sales_segment_stamped', 'sao_crm_opp_owner_geo_stamped') }}
