  ...
  SELECT
    ...
    CASE
       WHEN subscription.subscription_created_date < '2019-02-01'
         THEN NULL
       WHEN subscription.subscription_created_date BETWEEN '2019-02-01' AND '2021-04-11'
         THEN subscription_opportunity_mapping.dim_crm_opportunity_id
       ELSE subscription.dim_crm_opportunity_id
