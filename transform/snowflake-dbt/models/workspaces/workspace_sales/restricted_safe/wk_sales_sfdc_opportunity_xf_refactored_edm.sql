{{ config(alias='sfdc_opportunity_xf_refactored_ver_2') }}
...
WITH sfdc_opportunity AS (
    ...
    */
    ...
    SELECT *
    FROM {{ref('wk_sales_sfdc_opportunity_edm_mart_snippet')}}
...
-- keys used for aggregated historical analysis
  ...
  WHERE date_actual = CURRENT_DATE
    ...
    SELECT
      ...
      sfdc_opportunity_xf.quote_start_date,
      sfdc_opportunity_xf.quote_end_date,
      ...
      sfdc_opportunity_xf.partner_account_id AS partner_account,
      sfdc_opportunity_xf.partner_account_name,
      ...
      sfdc_opportunity_xf.resale_partner_id,
      sfdc_opportunity_xf.resale_partner_name,
      
      -- sfdc_opportunity_xf.platform_partner,
      sfdc_opportunity_xf.platform_partner_id AS platform_partner,
     ...
     ----------------------------------------------------------
      ...
      -- CASE
      --   WHEN sfdc_opportunity_xf.is_won = 1
      --       THEN '1.Won'
      --   WHEN sfdc_opportunity_xf.stage_name = '8-Closed Lost'
      --       THEN '2.Lost'
      --   WHEN sfdc_opportunity_xf.stage_name NOT IN ('8-Closed Lost', '9-Unqualified', 'Closed Won', '10-Duplicate')
      --       THEN '0. Open'
      --   ELSE 'N/A'
      ...
      -- CASE
      --   WHEN LOWER(sfdc_opportunity_xf.sales_type) like '%renewal%'
      --     THEN 1
      --   ELSE 0
      -- END                                                          AS is_renewal,
      ...
      sfdc_opportunity_xf.calculated_partner_track,
      sfdc_opportunity_xf.deal_path_engagement,
      sfdc_opportunity_xf.is_refund,
      sfdc_opportunity_xf.is_credit_flag,
      sfdc_opportunity_xf.is_contract_reset_flag,
      sfdc_opportunity_xf.is_won,
      sfdc_opportunity_xf.is_lost,
      sfdc_opportunity_xf.is_open,
      sfdc_opportunity_xf.is_duplicate_flag,
     ...
     -- date fields helpers
      ...
      sfdc_opportunity_xf.competitors_other_flag,
      sfdc_opportunity_xf.competitors_gitlab_core_flag,
      sfdc_opportunity_xf.competitors_none_flag,
      sfdc_opportunity_xf.competitors_github_enterprise_flag,
      sfdc_opportunity_xf.competitors_bitbucket_server_flag,
      sfdc_opportunity_xf.competitors_unknown_flag,
      sfdc_opportunity_xf.competitors_github_flag,
      sfdc_opportunity_xf.competitors_gitlab_flag,
      sfdc_opportunity_xf.competitors_jenkins_flag,
      sfdc_opportunity_xf.competitors_azure_devops_flag,
      sfdc_opportunity_xf.competitors_svn_flag,
      sfdc_opportunity_xf.competitors_bitbucket_flag,
      sfdc_opportunity_xf.competitors_atlassian_flag,
      sfdc_opportunity_xf.competitors_perforce_flag,
      sfdc_opportunity_xf.competitors_visual_studio_flag,
      sfdc_opportunity_xf.competitors_azure_flag,
      sfdc_opportunity_xf.competitors_amazon_code_commit_flag,
      sfdc_opportunity_xf.competitors_circleci_flag,
      sfdc_opportunity_xf.competitors_bamboo_flag,
      sfdc_opportunity_xf.competitors_aws_flag,
      ...
      sfdc_opportunity_xf.is_comp_new_logo_override,
    ...
    --         THEN 'Lost'
    --     WHEN sfdc_opportunity_xf.stage_name IN ('Closed Won')
    --         THEN 'Closed Won'
    --     ELSE 'Other'
    ...
    --         THEN '4+ Pipeline'
    --     WHEN sfdc_opportunity_xf.stage_name IN ('8-Closed Lost', 'Closed Lost')
    --         THEN 'Lost'
    --     WHEN sfdc_opportunity_xf.stage_name IN ('Closed Won')
    --         THEN 'Closed Won'
    --     ELSE 'Other'
    ...
    --     WHEN sfdc_opportunity.opportunity_category IN ('Decommission')
    --       THEN -1
    --     WHEN sfdc_opportunity_xf.opportunity_category IN ('Credit')
    --       THEN 0
    --     ELSE 1
    ...
    --   END                                                                       AS is_excluded_flag,
      ...
      sfdc_opportunity_xf.is_stage_1_plus,
      sfdc_opportunity_xf.is_stage_3_plus,
      sfdc_opportunity_xf.is_stage_4_plus,
      ...
      sfdc_opportunity_xf.calculated_deal_count,
      sfdc_opportunity_xf.partner_engaged_opportunity_flag,
      sfdc_opportunity_xf.renewal_timing_status,
      sfdc_opportunity_xf.is_excluded_flag,
...
--         ON edm_opty.dim_crm_opportunity_id = sfdc_opportunity_xf.opportunity_id
    FROM edm_opty AS sfdc_opportunity_xf
    ...
    LEFT JOIN date_details start_date
      ON sfdc_opportunity_xf.quote_start_date::DATE = start_date.date_actual
    ...
    LEFT JOIN date_details iacv_created_date
      ON iacv_created_date.date_actual = sfdc_opportunity_xf.pipeline_created_date::DATE
    ...
    LEFT JOIN sfdc_accounts_xf partner_account
      ON partner_account.account_id = sfdc_opportunity_xf.partner_account_id
    -- NF 20211105 resale partner
    LEFT JOIN sfdc_accounts_xf resale_account
      ON resale_account.account_id = sfdc_opportunity_xf.resale_partner_id
