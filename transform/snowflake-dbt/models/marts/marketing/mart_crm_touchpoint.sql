...
, final AS (
    ...
    SELECT
      ...
      fct_campaign.large_bucket,
      fct_campaign.reporting_type,
      fct_campaign.allocadia_id,
      fct_campaign.is_a_channel_partner_involved,
      fct_campaign.is_an_alliance_partner_involved,
      fct_campaign.is_this_an_in_person_event,
      fct_campaign.alliance_partner_name,
      fct_campaign.channel_partner_name,
      fct_campaign.sales_play,
      fct_campaign.gtm_motion,
