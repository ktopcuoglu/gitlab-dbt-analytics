...
, final AS (
    ...
    SELECT
      ...
      dim_crm_sales_representative.crm_user_sales_segment                   AS touchpoint_crm_user_segment_name_live,
      dim_crm_sales_representative.crm_user_geo                             AS touchpoint_crm_user_geo_name_live,
      dim_crm_sales_representative.crm_user_region                          AS touchpoint_crm_user_region_name_live,
      dim_crm_sales_representative.crm_user_area                            AS touchpoint_crm_user_area_name_live,
