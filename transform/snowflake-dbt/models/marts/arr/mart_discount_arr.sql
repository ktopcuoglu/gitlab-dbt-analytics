WITH dim_date AS (
    ...
    SELECT
      ...
      dim_crm_account_invoice.dim_parent_crm_account_id                 AS parent_crm_account_id_invoice,
      ...
      dim_crm_account_subscription.dim_parent_crm_account_id            AS parent_crm_account_id_subscription,
