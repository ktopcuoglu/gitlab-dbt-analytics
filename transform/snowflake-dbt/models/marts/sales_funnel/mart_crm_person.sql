...
, final AS (
    ...
    SELECT
      ...
      inquiry_datetime_inferred.date_day       AS inquiry_inferred_date,
      fct_crm_person.inquiry_datetime_inferred,
      inquiry_datetime_inferred_pt.date_day            
                                               AS inquiry_inferred_date_pt,
      inquiry_datetime_inferred.first_day_of_month     
                                               AS inquiry_inferred_month,
      inquiry_datetime_inferred_pt.first_day_of_month  
    ...
    LEFT JOIN dim_date AS inquiry_datetime_inferred
      ON fct_crm_person.inquiry_datetime_inferred_id = inquiry_datetime_inferred.date_id
    LEFT JOIN dim_date AS inquiry_datetime_inferred_pt
      ON fct_crm_person.inquiry_datetime_inferred_pt_id = inquiry_datetime_inferred_pt.date_id
