...
, final AS (
    ...
    SELECT
      ...
      lead_created_date.date_day               AS lead_created_date_pt,
      lead_created_date.first_day_of_month     AS lead_created_month,
      lead_created_date.first_day_of_month     AS lead_created_month_pt,
      contact_created_date.date_day            AS contact_created_date,
      contact_created_date.date_day            AS contact_created_date_pt,
      contact_created_date.first_day_of_month  AS contact_created_month,
      contact_created_date.first_day_of_month  AS contact_created_month_pt,
