...
, final AS (
  ...
  SELECT 
    ...
    mart_crm_opportunity_daily_snapshot.is_eligible_created_pipeline AS is_eligible_created_pipeline_snapshot,
    mart_crm_opportunity.is_eligible_created_pipeline AS is_eligible_created_pipeline_live,
    mart_crm_opportunity_daily_snapshot.is_eligible_sao AS is_eligible_sao_snapshot,
    ...
    mart_crm_opportunity_daily_snapshot.is_excluded AS is_excluded_snapshot,
    ...
    mart_crm_opportunity_daily_snapshot.quote_start_date AS quote_start_date_snapshot,
    mart_crm_opportunity.quote_start_date AS quote_start_date_live,
    mart_crm_opportunity_daily_snapshot.quote_start_month AS quote_start_month_snapshot,
    mart_crm_opportunity.quote_start_month AS quote_start_month_live,
    mart_crm_opportunity_daily_snapshot.quote_start_fiscal_quarter_date AS quote_start_fiscal_quarter_date_snapshot,
    mart_crm_opportunity.quote_start_fiscal_quarter_date AS quote_start_fiscal_quarter_date_live,
    mart_crm_opportunity_daily_snapshot.quote_start_fiscal_quarter_name AS quote_start_fiscal_quarter_name_snapshot,
    mart_crm_opportunity.quote_start_fiscal_quarter_name AS quote_start_fiscal_quarter_name_live,
    mart_crm_opportunity_daily_snapshot.quote_start_fiscal_year AS quote_start_fiscal_year_snapshot,
    mart_crm_opportunity.quote_start_fiscal_year AS quote_start_fiscal_year_live,
    mart_crm_opportunity_daily_snapshot.quote_end_date AS quote_end_date_snapshot,
    mart_crm_opportunity.quote_end_date AS quote_end_date_live,
    mart_crm_opportunity_daily_snapshot.quote_end_month AS quote_end_month_snapshot,
    mart_crm_opportunity.quote_end_month AS quote_end_month_live,
    mart_crm_opportunity_daily_snapshot.quote_end_fiscal_quarter_date AS quote_end_fiscal_quarter_date_snapshot,
    mart_crm_opportunity.quote_end_fiscal_quarter_date AS quote_end_fiscal_quarter_date_live,
    mart_crm_opportunity_daily_snapshot.quote_end_fiscal_quarter_name AS quote_end_fiscal_quarter_name_snapshot,
    mart_crm_opportunity.quote_end_fiscal_quarter_name AS quote_end_fiscal_quarter_name_live,
    mart_crm_opportunity_daily_snapshot.quote_end_fiscal_year AS quote_end_fiscal_year_snapshot,
    mart_crm_opportunity.quote_end_fiscal_year AS quote_end_fiscal_year_live,
