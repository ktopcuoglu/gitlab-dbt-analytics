...
, dim_crm_user_hierarchy_live_sales_segment AS (
    ...
    SELECT
      ...
      dim_crm_account.account_demographics_sales_segment,
      dim_crm_account.account_demographics_geo,
      dim_crm_account.account_demographics_region,
      dim_crm_account.account_demographics_area,
      dim_crm_account.account_demographics_territory,
      dim_crm_account.account_demographics_employee_count,
      dim_crm_account.account_demographics_max_family_employee,
      dim_crm_account.account_demographics_upa_country,
      dim_crm_account.account_demographics_upa_state,
      dim_crm_account.account_demographics_upa_city,
      dim_crm_account.account_demographics_upa_street,
      dim_crm_account.account_demographics_upa_postal_code,
