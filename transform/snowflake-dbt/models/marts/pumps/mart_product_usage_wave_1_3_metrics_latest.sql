...
, joined AS (
    ...
    SELECT
      ...
      latest_metrics.gitlab_shared_runners_enabled,
      latest_metrics.container_registry_enabled,
      ...
      latest_metrics.object_store_packages_enabled,
      ...
      -- Wave 3.2
      latest_metrics.auto_devops_enabled,
      latest_metrics.gitaly_clusters_instance,
      latest_metrics.epics_deepest_relationship_level_instance,
