...
, joined AS (
    ...
    SELECT
      ...
      latest_metrics.projects_with_packages_28_days_users,
      latest_metrics.deployments_28_days_users,
      latest_metrics.releases_28_days_users,
      latest_metrics.epics_28_days_users,
      latest_metrics.issues_28_days_users,
