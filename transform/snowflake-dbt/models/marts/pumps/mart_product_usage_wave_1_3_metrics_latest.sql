...
, joined AS (
    ...
    SELECT
      ...
      latest_metrics.instance_gitlab_shared_runners_enabled,
      latest_metrics.instance_container_registry_enabled,
      ...
      latest_metrics.instance_object_store_packages_enabled,
      ...
      -- Wave 3.2
      latest_metrics.instance_auto_devops_enabled,
      latest_metrics.instance_gitaly_clusters,
      latest_metrics.instance_epics_deepest_relationship_level,
      ...
      latest_metrics.requirements_with_test_report_all_time_event,
