...
, joined AS (
    ...
    SELECT
      ...
      latest_metrics.analytics_total_unique_counts_monthly,
      latest_metrics.issues_edit_total_unique_counts_monthly,
      latest_metrics.user_packages_total_unique_counts_monthly,
      latest_metrics.terraform_state_api_unique_users_monthly,
      latest_metrics.incident_management_total_unique_counts_monthly,
