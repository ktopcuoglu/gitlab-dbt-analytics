...
, months AS (
    ...
    SELECT DISTINCT
      ...
      {{ usage_ping_month_range('gitaly_clusters_all_time_event') }},
    ...
    SELECT
      ...
      {{ usage_ping_over_ping_difference('gitaly_clusters_all_time_event') }},
    ...
    SELECT
      ...
      {{ usage_ping_over_ping_smoothed('gitaly_clusters_all_time_event') }},
    ...
    SELECT
      ...
      {{ usage_ping_over_ping_estimated('gitaly_clusters_all_time_event') }},
