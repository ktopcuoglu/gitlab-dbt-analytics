...
, joined AS (
    ...
    SELECT
      ...
      monthly_metrics.projects_with_packages_28_days_users,
      monthly_metrics.deployments_28_days_users,
      monthly_metrics.releases_28_days_users,
      monthly_metrics.epics_28_days_users,
      monthly_metrics.issues_28_days_users,
