...
dbt_non_product_models_command = f"""
    {pull_commit_hash} &&
    {dbt_install_deps_and_seed_cmd} &&
    dbt run --profiles-dir profile --target prod --exclude tag:product snapshots mart_arr_snapshots sources.sheetload+ sources.sfdc sources.zuora --vars {xs_warehouse}; ret=$?;
