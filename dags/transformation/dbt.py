...
dbt_non_product_models_command = f"""
    {pull_commit_hash} &&
    {dbt_install_deps_cmd} &&
    dbt run --profiles-dir profile --target prod --exclude tag:datasiren tag:product legacy.snapshots legacy.sheetload sources.gitlab_dotcom sources.sheetload sources.sfdc sources.zuora; ret=$?;
