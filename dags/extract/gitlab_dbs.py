    ...
    with extract_dag:
        ...
        for table in table_list:
            ...
            freshness = KubernetesPodOperator(
                **gitlab_defaults,
                image=DBT_IMAGE,
                task_id=f"{config['task_name']}-{table.replace('_','-')}-source-freshness",
                name=f"{config['task_name']}-{table.replace('_','-')}-source-freshness",
            ...
            test = KubernetesPodOperator(
                **gitlab_defaults,
                image=DBT_IMAGE,
                task_id=f"{config['task_name']}-{table.replace('_','-')}-source-test",
                name=f"{config['task_name']}-{table.replace('_','-')}-source-test",
                secrets=standard_secrets + dbt_secrets,
                env_vars=standard_pod_env_vars,
                arguments=[test_cmd],
            )
            ...
            if has_snapshot:
                ...
                snapshot = KubernetesPodOperator(
                    **gitlab_defaults,
                    image=DBT_IMAGE,
                    task_id=f"{config['task_name']}-{table.replace('_','-')}-source-snapshot",
                    name=f"{config['task_name']}-{table.replace('_','-')}-source-snapshot",
                    secrets=standard_secrets + dbt_secrets,
                    env_vars=standard_pod_env_vars,
            ...
            if has_models:
                ...
                model_run = KubernetesPodOperator(
                    **gitlab_defaults,
                    image=DBT_IMAGE,
                    task_id=f"{config['task_name']}-{table.replace('_','-')}-source-model-run",
                    name=f"{config['task_name']}-{table.replace('_','-')}-source-model-run",
                    secrets=standard_secrets + dbt_secrets,
                    env_vars=standard_pod_env_vars,
                ...
                model_test = KubernetesPodOperator(
                    **gitlab_defaults,
                    image=DBT_IMAGE,
                    task_id=f"{config['task_name']}-{table.replace('_','-')}-model-test",
                    name=f"{config['task_name']}-{table.replace('_','-')}-model-test",
                    secrets=standard_secrets + dbt_secrets,
                    env_vars=standard_pod_env_vars,
