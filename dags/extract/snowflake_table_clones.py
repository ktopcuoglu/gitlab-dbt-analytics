...
container_cmd = f"""
    ...
    python3 manage_snowflake.py create-table-clone --source_schema analytics --source_table mart_arr --target_schema analytics_clones  --target_table "mart_arr_$CLONE_NAME_DATE" --timestamp "$CLONE_DATE 06:59:00"
"""
